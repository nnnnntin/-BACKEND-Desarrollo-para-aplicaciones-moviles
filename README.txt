# BACKEND Desarrollo para Aplicaciones Móviles
...
1. Clona el repositorio desde una terminal de git bash:
    git clone https://github.com/nnnnntin/-BACKEND-Desarrollo-para-aplicaciones-moviles.git
2. Entra en el directorio del proyecto:
    cd -BACKEND-Desarrollo-para-aplicaciones-moviles
