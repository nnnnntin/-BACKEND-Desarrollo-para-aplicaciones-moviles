...
const getDisponibilidadByIdController = async (req, res) => {
  ...
  try {
    ...
    if (!disponibilidad) {
      return res.status(404).json({ message: `No se ha encontrado la disponibilidad con id: ${id}` });
    }
...
const createDisponibilidadController = async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({ message: "Disponibilidad creada correctamente", disponibilidad });
  } catch (error) {
    console.error(error);
...
const reservarFranjaController = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Franja horaria reservada correctamente", disponibilidad });
  } catch (error) {
    console.error(error);
...
const liberarFranjaController = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Franja horaria liberada correctamente", disponibilidad });
  } catch (error) {
    console.error(error);
...
const bloquearFranjaController = async (req, res) => {
  ...
  const { entidadId, tipoEntidad, fecha, horaInicio, horaFin, motivo, recurrente, diasRecurrencia, fechaFinRecurrencia } = value;
  ...
  try {
    if (recurrente) {
      ...
      res.status(200).json({ message: "Franja horaria bloqueada correctamente", disponibilidad });
    }
  } catch (error) {
    console.error(error);
...
const desbloquearFranjaController = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Franja horaria desbloqueada correctamente", disponibilidad });
  } catch (error) {
    console.error(error);
